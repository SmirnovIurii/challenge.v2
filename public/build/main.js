...
var map = {
	...
	"../pages/edit-todo/edit-todo.module": [
		499,
		4
	],
	...
	"../pages/new-todo/new-todo.module": [
		502,
		1
	],
...
var TodoListService = /** @class */ (function () {
    function TodoListService(db) {
        this.db = db;
        this.todolisttogo = this.db.list('todo-list');
        this.todolistcomleate = this.db.list('todo-list-compleate');
    }
    TodoListService.prototype.getTodoList = function () {
        return this.todolisttogo;
    };
    TodoListService.prototype.getTodoListFinish = function () {
        return this.todolistcomleate;
    };
    TodoListService.prototype.addTodo = function (todo) {
        return this.todolisttogo.push(todo);
    };
    TodoListService.prototype.editTodo = function (todo) {
        return this.todolisttogo.update(todo.key, todo);
    };
    TodoListService.prototype.finishTodo = function (todo) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2__ = __webpack_require__(488);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__firebase_config__ = __webpack_require__(497);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_todolist_todolist_service__ = __webpack_require__(286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_toast_toast_service__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_angularfire2_auth__ = __webpack_require__(154);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_auth_auth_service__ = __webpack_require__(288);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["d" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_4__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/edit-todo/edit-todo.module#EditTodoPageModule', name: 'EditTodoPage', segment: 'edit-todo', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/home/home.module#HomeModule', name: 'HomePage', segment: 'home', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/login/login.module#LoginPageModule', name: 'LoginPage', segment: 'login', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/new-todo/new-todo.module#NewTodoPageModule', name: 'NewTodoPage', segment: 'new-todo', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/register/register.module#RegisterPageModule', name: 'RegisterPage', segment: 'register', priority: 'low', defaultHistory: [] }
                    ]
                }),
                __WEBPACK_IMPORTED_MODULE_3_angularfire2__["AngularFireModule"].initializeApp(__WEBPACK_IMPORTED_MODULE_8__firebase_config__["a" /* FIREBASE_CONFIG */]),
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__services_todolist_todolist_service__["a" /* TodoListService */],
                __WEBPACK_IMPORTED_MODULE_10__services_toast_toast_service__["a" /* ToastService */],
                __WEBPACK_IMPORTED_MODULE_12__services_auth_auth_service__["a" /* AuthService */],
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* NavPush */],
            ]
        })
    ], AppModule);
    return AppModule;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Сергей\code\challenge.v1.0.1\src\app\app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Users\Сергей\code\challenge.v1.0.1\src\app\app.html"*/
        }),
...
var FIREBASE_CONFIG = {
    apiKey: "AIzaSyBRzVtG1wcF2gRafRFHKJLpLzy8WNHmObs",
    authDomain: "challenge-d1bee.firebaseapp.com",
    databaseURL: "https://challenge-d1bee.firebaseio.com",
    projectId: "challenge-d1bee",
    storageBucket: "challenge-d1bee.appspot.com",
    messagingSenderId: "518546271649"
};
